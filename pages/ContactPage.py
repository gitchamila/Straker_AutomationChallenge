...
#Verifications
    def verification(self):
        expect(self.success_message).to_be_visible()                    #Verify that successfully message is visible
        expect(self.success_message).to_contain_text(                   #Verify that successfully message is in correct text content
            "Thank you! You're successfully subscribed!")

        expect(self.email_subscription_textbox).not_to_be_visible()
